...
// import '../controller/game_controller_nxn.dart';
...
//   final int gridSize;
//   const GameScreenNxN({super.key, this.gridSize = 5});
...
//   // Track previous controller state to detect changes
...
//         //  if ((i == 0 && j == 0) || controller.isFixed[i][j]) continue;{
...
//       // Update model using controller method
...
//       create: (_) => GameController(gridSize: widget.gridSize),
//       child: Consumer<dynamic>(
//         builder: (context, controller, _) {
//           // Initialize grid state once after controller finishes generating
...
//           // Monitor game state changes - only trigger on state transition
//           // Check if game has stopped and we haven't already handled it
...
//           if (gameJustStopped) {
//             // Mark that we've now seen it in a stopped state
//             _lastControllerPlayingState = false;
//             _endDialogShown = true;
//             _isProcessingEnd = true;
//             // Don't call addPostFrameCallback here - this causes infinite loops
//             // The game completion check is already handled in _checkIfAllCellsFilled
//           } else if (controller.isPlaying) {
//             // Track when game is playing
//             _lastControllerPlayingState = true;
//           }
